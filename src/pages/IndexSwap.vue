  ...
  <Layout>
    ...
    >
      <div class="text-4xl font-bold w-full sm:w-3/5 text-center sm:text-left">
        ...
        <div class="text-green-700 leading-tight">
          Mathematics Teacher &amp; Web Developper
        </div>
      </div>
    ...
    <div class="container-inner mx-auto">
      <p class="text-lg sm:text-xl">
        ...
        or check out the
        <a
          href="https://www.youtube.com/watch?v=uHo6o1TNQeE"
        >screencast I did</a>. Feel free to use it for your own site or projects! Lorem, ipsum dolor
            ...
            >
              <div class="flex flex-wrap mb-6 -mx-4">
                <div class="w-full md:w-1/2 mb-6 md:mb-0 px-4">
                  <label
                    class="block mb-2 text-copy-primary"
                    for="name"
                  >
                    Name
                  </label>
                ...
                <div class="w-full px-4 md:w-1/2">
                  <label
                    class="block text-copy-primary mb-2"
                    for="email"
                  >
                    Email Address
                  </label>
