<template>
  <div class="pt-24">
    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      ...
      >
        <p class="uppercase tracking-loose w-full">David Couronné</p>
        <h1 class="my-4 text-5xl font-bold leading-tight">Professional reconversion to Web Developper</h1>
        <p
          class="leading-normal text-2xl mb-8"
        >I have been teaching mathematics for over 20 years and have fallen in love with programming.</p>
