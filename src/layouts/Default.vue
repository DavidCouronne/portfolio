  ...
  <v-app :dark="setTheme">
    ...
    >
      <v-list dense nav>
        <v-list-item>
          <v-list-item-content>
            <v-list-item-title class="title">David</v-list-item-title>
    ...
    <v-app-bar :clipped-left="clipped" fixed app dark dense color="black">
      ...
      <v-toolbar-items class="hidden-sm-and-down">
        <v-btn :to="$url('/')">Home</v-btn>
        <v-btn :to="$url('/blog')">Blog</v-btn>
        <v-btn :to="$url('/docs')">Documentation</v-btn>
      </v-toolbar-items>
